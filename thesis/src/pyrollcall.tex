...
\begin{figure}[b!]
    \centering
        \begin{subfigure}[b]{0.32\linewidth}
            \includegraphics[width=\linewidth]{preview1.eps}
            \caption{Managing courses.}
        \end{subfigure}
        \begin{subfigure}[b]{0.32\linewidth}
            \includegraphics[width=\linewidth]{preview2.eps}
...
\begin{figure}[h!]
    \centering
        ...
        \end{subfigure}
        \begin{subfigure}[b]{0.32\linewidth}
            \includegraphics[width=\linewidth]{exp03.eps}
            \caption{U10516003 Ellie Sattler.}
        \end{subfigure}
        \begin{subfigure}[b]{0.32\linewidth}
            \includegraphics[width=\linewidth]{exp04.eps}
            \caption{U10516004 Ian Malcolm.}
        \end{subfigure}
        \begin{subfigure}[b]{0.32\linewidth}
            \includegraphics[width=\linewidth]{exp05.eps}
            \caption{U10516005 John Hammond.}
        \end{subfigure}
        \begin{subfigure}[b]{0.32\linewidth}
            \includegraphics[width=\linewidth]{exp06.eps}
